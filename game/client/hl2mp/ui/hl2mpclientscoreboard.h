...
private:
	...
	vgui::Label *m_pWinsHeader_DM; //DHL - Skillet
	...
	vgui::Label	*m_pWinsLabel_R; //DHL - Skillet
	vgui::Label *m_pWinsHeader_R; //DHL - Skillet
	...
	vgui::Label	*m_pWinsLabel_C; //DHL - Skillet
	vgui::Label *m_pWinsHeader_C; //DHL - Skillet
	...
	//DHL - Skillet
protected:
	CPanelAnimationVarAliasType( int, m_iWinsWidth, "wins_width", "35", "proportional_int" );
};
