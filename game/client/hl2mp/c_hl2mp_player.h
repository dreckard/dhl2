...
public:
	...
	//DHL - Skillet
	Vector m_vecClientViewPos;
	C_BaseEntity* m_pDeathViewEnt;
	float m_flDeathViewEntEndTime;
	
	virtual bool CanSprint( void ); //DHL - Skillet - Virtual
	...
	//DHL - Skillet
	bool m_bUnderwaterSoundEffects;
...
public:
	...
	void ClientThink( void ); //DHL - Skillet
	Vector GetRagdollVelocity( void ) { return m_vecRagdollVelocity; }
