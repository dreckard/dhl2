...
public:
	...
	void						DrawScaledIconProgressBar( int x, int y, int width, int height, CHudTexture *icon, CHudTexture *icon2, float percentage, Color& clr, int type ); //DHL - Payback
