...
//DHL - Skillet
#include "dhl/WeaponSelectionMenu.h"
#include "dhl/WeaponSelectionMelee.h"
#include "dhl/WeaponSelectionPistols.h"
#include "dhl/WeaponSelectionAutos.h"
#include "dhl/WeaponSelectionShotguns.h"
#include "dhl/WeaponSelectionRifles.h"
#include "dhl/TeamSelectionMenu.h"
#include "dhl/ItemSelectionMenu.h"
...
void CBaseViewport::OnScreenSizeChanged(int iOldWide, int iOldTall)
{
	...
	gHUD.VidInit(); //DHL - Skillet - Valve's comments claim that this gets called on video mode change, but it didn't before this addition
}
...
void CBaseViewport::CreateDefaultPanels( void )
{
	...
	//DHL
	AddNewPanel( CreatePanelByName( PANEL_WEAPONSELECTION ), "PANEL_DHLWEPSEL" );
	AddNewPanel( CreatePanelByName( PANEL_TEAMSELECTION ), "PANEL_DHLTEAMSEL" );
...
/*	else if ( Q_strcmp(PANEL_OVERVIEW, szPanelName) == 0 )
	...
	*/
	...
	//DHL - Skillet
	else if ( Q_strcmp(PANEL_WEAPONSELECTION, szPanelName) == 0 )
	{
		newpanel = new CWeaponSelectionMenu( this );
	}
	else if ( Q_strcmp(PANEL_TEAMSELECTION, szPanelName) == 0 )
	{
		newpanel = new CTeamSelectionMenu( this );
	}
	/*else if ( Q_strcmp(PANEL_WEAPONSELECTIONMELEE, szPanelName) == 0 )
	{
		newpanel = new CWeaponSelectionMelee( this );
	}
	else if ( Q_strcmp(PANEL_WEAPONSELECTIONPISTOLS, szPanelName) == 0 )
	{
		newpanel = new CWeaponSelectionPistols( this );
	}
	else if ( Q_strcmp(PANEL_WEAPONSELECTIONAUTOS, szPanelName) == 0 )
	{
		newpanel = new CWeaponSelectionAutos( this );
	}
	else if ( Q_strcmp(PANEL_WEAPONSELECTIONSHOTGUNS, szPanelName) == 0 )
	{
		newpanel = new CWeaponSelectionShotguns( this );
	}
	else if ( Q_strcmp(PANEL_WEAPONSELECTIONRIFLES, szPanelName) == 0 )
	{
		newpanel = new CWeaponSelectionRifles( this );
	}
	else if ( Q_strcmp(PANEL_ITEMSELECTION, szPanelName) == 0 )
	{
		newpanel = new CItemSelectionMenu( this );
	}*/
#endif
