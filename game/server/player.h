...
//DHL
#include "dhl/playerweaponselection.h"
...
public:
	...
	virtual void SetMaxSpeed( float flMaxSpeed ) { m_flMaxspeed = flMaxSpeed; } //DHL - Skillet - Virtual
...
protected: //used to be private, but need access for portal mod (Dave Kircher)
	...
	IPhysicsObject				*m_pShadowProne; //DHL
	Vector						m_oldOrigin;
...
// Not transmitted
	...
	//DHL - Skillet - Need access to this in CDHL_Player
protected:
	int				m_nImpulse;
private:
