...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_DHL_IDLE_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_RUN_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_IDLE_CROUCH_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_WALK_CROUCH_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_JUMP_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_GESTURE_RELOAD_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_DIVE_GENERIC );
	ADD_ACTIVITY_TO_SR( ACT_DHL_DIVE_GENERIC_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_PRONE_GENERIC );
	ADD_ACTIVITY_TO_SR( ACT_DHL_PRONE_GENERIC_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_DHL_PRONEMOVE_GENERIC );
	ADD_ACTIVITY_TO_SR( ACT_DHL_PRONEMOVE_GENERIC_AKIMBO );
	//View model activities
	ADD_ACTIVITY_TO_SR( ACT_VM_DHL_COCK );
	ADD_ACTIVITY_TO_SR( ACT_VM_DHL_SCOPE );
	ADD_ACTIVITY_TO_SR( ACT_VM_DHL_UNSCOPE );
