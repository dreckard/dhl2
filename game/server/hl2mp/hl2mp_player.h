...
public:
	...
	virtual void FlashlightTurnOff( void ); //DHL - Skillet - Virtual
	void	PrecacheFootStepSounds( void );
	virtual bool	ValidatePlayerModel( const char *pModel ); //DHL - Skillet - Virtual
	...
	virtual void SetPlayerModel( void ); //DHL - Skillet - Virtual
	virtual void SetPlayerTeamModel( void ); //DHL - Skillet - Virtual
