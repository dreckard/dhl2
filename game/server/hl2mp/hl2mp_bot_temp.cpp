...
#include "dhl/dhl_shareddefs.h" //DHL - Skillet

void ClientPutInServer( edict_t *pEdict, const char *playername );
void Bot_Think( CHL2MP_Player *pBot );

//#ifdef DEBUG //DHL - Commented
...
//DHL - Skillet
ConVar bot_playermodel( "bot_playermodel", "", 0, "Force bot player model." );
...
CON_COMMAND_F( bot_add, "Add a bot", FCVAR_CHEAT )
{
	...
	//Team picking code shamelessly ripped from BG2 - thanks Tjoppen
	static bool iLastTeam = 0;
	BotPutInServer( 0, TEAM_COMBINE + iLastTeam );
	iLastTeam = !iLastTeam;
}
