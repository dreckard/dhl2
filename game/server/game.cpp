...
ConVar	falldamage( "mp_falldamage","1", FCVAR_NOTIFY ); //DHL
ConVar	weaponstay( "mp_weaponstay","1", FCVAR_NOTIFY ); //DHL
ConVar	forcerespawn( "mp_forcerespawn","0", FCVAR_NOTIFY ); //DHL
