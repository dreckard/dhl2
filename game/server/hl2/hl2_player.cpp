...
#ifdef HL2MP
	#define	HL2_WALK_SPEED DHL_WALK_SPEED //150
	#define	HL2_NORM_SPEED DHL_NORM_SPEED //190
	#define	HL2_SPRINT_SPEED DHL_SPRINT_SPEED //320
#else
...
//#ifndef _XBOX 
	...
	if ( IsSuitEquipped() && CanZoom( this ) ) //DHL - Skillet - Added CanZoom check
	{
...
bool CHL2_Player::Weapon_CanSwitchTo( CBaseCombatWeapon *pWeapon )
{
	...
	//DHL - Skillet - Allow selection of empty weapons (for dropping)
