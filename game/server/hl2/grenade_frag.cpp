...
#define DHL_GRENADE_MODEL "models/weapons/m67/w_m67.mdl" //DHL - Skillet
...
public:
	...
	void	BlipSound() { /*EmitSound( "Grenade.Blip" )*/; } //DHL - Skillet - No beeping
	void	DelayThink();
...
{
	PrecacheModel( DHL_GRENADE_MODEL );
...
void CGrenadeFrag::SetTimer( float detonateDelay, float warnDelay )
{
	...
	//DHL - Skillet - Real grenades don't glow or beep for obvious reasons
	//CreateEffects();
}
