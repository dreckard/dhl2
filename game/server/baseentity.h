...
private:
	...
	// DHL - Skillet - Handle bullets penetrating solids
	bool HandleShotPenetration( const FireBulletsInfo_t &info, const trace_t &tr, const Vector &vecDir, const Vector &vecEnd, ITraceFilter *pTraceFilter );
	public:
		virtual bool ShouldTouch( CBaseEntity *pOther, trace_t &trace ) { return true; } //DHL - Skillet
	private:
