...
//DHL - Skillet
//This is used in the projectile code to find out from a GetTouchTrace() which hitbox damage should be dealt based on
class CTraceFilterHitOneEntity : public CTraceFilterSimple
{
public:
	CTraceFilterHitOneEntity( const IHandleEntity *hitentity, int collisionGroup );
...
void		UTIL_BloodDecalTrace( trace_t *pTrace, int bloodColor, bool bSkipPredictionCull = false ); //DHL - Skillet - Added cull skip option
