...
{
	//DHL - Skillet
	if ( !IsPlayer() && !other->IsPlayer() ) //If either of us are players this check has already been run from the gamemovement code
	{
		if ( !ShouldTouch( other, trace ) || !other->ShouldTouch( this, trace ) )
			return;
	}
