...
//HL2MP
	...
	//DHL - Skillet - Distraction activities
	//Player model activities
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_IDLE_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_RUN_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_IDLE_CROUCH_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_WALK_CROUCH_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_JUMP_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_GESTURE_RELOAD_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_DIVE_GENERIC );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_DIVE_GENERIC_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_PRONE_GENERIC );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_PRONE_GENERIC_AKIMBO );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_PRONEMOVE_GENERIC );
	REGISTER_SHARED_ACTIVITY ( ACT_DHL_PRONEMOVE_GENERIC_AKIMBO );
	//View model activities
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DHL_COCK );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DHL_SCOPE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_DHL_UNSCOPE );
