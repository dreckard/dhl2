...
#include "dhl_nightvision_vs20.inc"
...
if ( g_pMaterialSystemHardwareConfig->GetDXSupportLevel() >= 80 )
{
		...
		IMaterial *pMaterial = materials->FindMaterial( "dhl_shaders/dhl_nightvision", TEXTURE_GROUP_CLIENT_EFFECTS, true );
		if ( pMaterial )
		{
...
BEGIN_VS_SHADER( dhl_nightvision, "Nightvision shader" )
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			pShaderShadow->SetVertexShader( "dhl_nightvision_vs20", 0 );
			pShaderShadow->SetPixelShader( "dhl_nightvision_ps20" );
