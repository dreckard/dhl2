...
public:
	...
	//DHL - Skillet - Accessor functions to allow modification of commands intended for the engine
	void						SetCommandCallback( FnCommandCallback_t newCallback ) { m_fnCommandCallback = newCallback; }
	FnCommandCallback_t			GetCommandCallback( void ) { return m_fnCommandCallback; }
...
public:
	...
	//DHL - To allow modification of commands intended for the engine
	//Currently unneeded
	/*void						SetChangeCallback( FnChangeCallback_t newCallback ) { m_fnChangeCallback = newCallback; }
	FnChangeCallback_t			GetChangeCallback( void ) { return m_fnChangeCallback; }
	void						DispatchCallback( void ) { m_fnChangeCallback( this, m_pszString ); }*/
