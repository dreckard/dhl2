...
rem === Many thanks to Marek of Empires mod for improved documentation of these variables - Skillet
...
set GAMEDIR=C:\PROGRA~1\Steam\STEAMA~1\SOURCE~1\dhl_dev
...
set SDKBINDIR=..\..\..\..\PROGRA~1\Steam\STEAMA~1\SKILLE~1.COM\SOURCE~2\bin\ORANGE~1\bin
...
%BUILD_SHADER% dhl_dx9_20b			-game %GAMEDIR% -source %SOURCEDIR%
